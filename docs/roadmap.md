...
- Benchmark scheduler CPU overhead, TTFT, ITL, tail latency, throughput, GPU utilization, and memory against matched incumbents; llama.cpp holds ~49.5 tok/s at c1 on the same artifact (engine c1: 20.2 tok/s).
